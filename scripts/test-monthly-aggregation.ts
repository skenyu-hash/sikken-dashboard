...
const EXPECTED = {
  ...
  // total_profit (water 通常式): revenue - labor - material - ad - sales_outsourcing - card_fee + internal_construction_profit
  // = 6750000 - 900000 - 450000 - 1350000 - 225000 - 90000 + 360000 = 4095000
  total_profit: 4095000,
  // profit_rate = 4095000 / 6750000 * 100 = 60.666..%、ROUND 60.7
  profit_rate: 60.7,
  // 特殊
  vehicle_count: 7, // MAX
