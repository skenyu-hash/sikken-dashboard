    ...
    if (entry) {
      ...
      setState((s) => {
        const next: EntryFormState = {
          ...
          locksmith_car_lp_email_call_count: numOrEmpty(entry.locksmith_car_lp_email_call_count),
          locksmith_inhouse_call_count: numOrEmpty(entry.locksmith_inhouse_call_count),
  ...
  const handleSave = useCallback(async (): Promise<SaveOutcome> => {
    ...
    try {
      ...
      const entry: DailyEntry = {
        ...
        locksmith_car_lp_email_call_count: numOrZero(state.locksmith_car_lp_email_call_count),
        locksmith_inhouse_call_count: numOrZero(state.locksmith_inhouse_call_count),
