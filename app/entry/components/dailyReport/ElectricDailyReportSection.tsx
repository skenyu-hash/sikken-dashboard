"use client";
// PR c95-A-3: 電気業態 DailyReport セクション。Water と同型 + ④ 施工に分電盤件数 1 行追加。
...
export default function ElectricDailyReportSection({ todayEntry: e }: Props) {
  ...
  const switchboard = num(e.switchboard_count); // 電気業態専用
    ...
    <div style={{
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
        ...
        <Panel num="④" title="施工" color="n4">
          ...
          <Row label="分電盤件数" value={cnt(switchboard)} />
