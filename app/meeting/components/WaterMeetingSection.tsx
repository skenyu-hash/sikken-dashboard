...
export default function WaterMeetingSection({
  ...
  return (
    <div className="metrics-grid-2col" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: SECTION.GAP, gridAutoRows: "min-content" }}>
      ...
      <SectionTable title="⑤ 水道専用" group="cnt" count={5} defaultOpen={false}>
        ...
        <MetricRow label="車両数"       actual={vehicleCount} target={targets.targetVehicleCount} {...mp} format={fmtCount} />
      </SectionTable>
    </div>
  );
}
